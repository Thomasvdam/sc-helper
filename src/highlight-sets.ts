...
const SKIPPED_REASON_LOW_BYTES = (bytes: number) => `Bytes too low (${bytes} < ${SET_BYTES_THRESHOLD})`;
...
function getUnprocessedSoundListItems(soundListItems: NodeListOf<Element>) {
